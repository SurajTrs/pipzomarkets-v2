    ...
    <div className="bg-dark text-light py-4">
      <Container>
        <Row className="mb-5 align-items-stretch">
          <Col md={8} className="d-flex">
            <div className="w-100 h-100 d-flex flex-column" style={{ padding: '3rem' }}>
              <div style={{ height: '200px', overflow: 'hidden', borderRadius: '0.5rem', marginBottom: '1.5rem' }}>
                ...
                <img src="/assets/start-trading.jpg" alt="Course Illustration" className="w-100" style={{ height: '100%', objectFit: 'cover' }} />
              </div>
              <div className="flex-grow-1 d-flex flex-column justify-content-center">
                <h1 className="fw-bold mt-3" style={{ fontSize: '2.25rem' }}>Start Trading Now… Quick & Dirty</h1>
                <p className="text-light mt-3" style={{ fontSize: '1rem' }}>
                  Ready to dive into the trading world? If you are eager to embark on a trading journey, our "Start Trading ..."
                ...
                <div className="d-flex gap-5 text-light small mt-4">
                  ...
                  <div><strong className="text-white">Students enrolled</strong><br />629,634</div>
                </div>
              </div>
            </div>
          </Col>
          <Col md={4} className="d-flex">
            <Card className="text-dark w-100 shadow h-100">
              <Card.Img variant="top" src="/assets/start-trading.jpg" />
              ...
              <Tab.Content>
                <Tab.Pane eventKey="description">
                  <p>
                    ...
                    to learn the fundamentals of financial markets. This course provides a short recap of our extended courses,
                    enabling us to tie together what we know with what is required.
                  </p>
                  <h5>What We Will Learn:</h5>
                  <ul>
                    <li><strong>Fundamental Ties:</strong> Link your financial understanding to trading essentials, seamlessly.</li>
                    <li><strong>Forex Unveiled:</strong> Demystify foreign exchange markets and learn safe, accessible trading techniques.</li>
                    <li><strong>Smart Instrument Use:</strong> Grasp the convenience of Contracts for Difference (CFDs) in financial markets.</li>
                    <li><strong>Market Mastery:</strong> Dive into market orders for strategic investment decisions.</li>
                    <li><strong>Analytical Insights:</strong> Extract valuable insights from financial analysis.</li>
                  </ul>
                  <h5>Level</h5>
                  <p>Beginner</p>
                  <h5>Pre-requisites</h5>
                  <ul>
                    <li>We strongly recommend you log into your trading account at AvaTrade for practice purposes</li>
        ...
        <Row className="g-3 mb-5">
          <Col md={4}><Card><Card.Img variant="top" src="/assets/trading-ETFS-868x439.jpg" /><Card.Body><span className="badge" style={{ backgroundColor: '#d9534f' }}>HOT</span><Card.Title>Trading Platforms Crash-Course</Card.Title><Card.Text>Free</Card.Text></Card.Body></Card></Col>
